      ...
      <div class="dialog">
        ...
        <div class="btn-wrapper">
          <template>
            ...
            >
              <v-img
                src="https://images.unsplash.com/photo-1587621012911-4d3ebcb04a87?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=600&q=60"
                height="200px"
              ></v-img>
        ...
        <mu-button @click="show = !show"> Cancel</mu-button>
      </div>
    </div>
  </div>
</template>
